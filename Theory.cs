...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        if (!skip1)
        {
            ...
            Console.WriteLine("1.10 Введите элементы массива");

            for (i = 0; i < nums2.Length; i++)
            {
                double.TryParse(Console.ReadLine(), out nums2[i]);
            }
            ...
            if (double.TryParse(Console.ReadLine(), out q) && q <= 10 && q >= 1)
            {
                while (i < 10)
                {
                    if (nums2[i] == q)
            ...
            if (double.TryParse(Console.ReadLine(), out p) && p <= 10 && p >= 1)
            {
                while (i < 10)
                {
                    if (nums2[i] == p)
            ...
            Console.WriteLine($"1.10 Кол-во элементов: {ip - iq - 1}");
